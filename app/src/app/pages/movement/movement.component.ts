  ...
  ngOnInit() {
    ...
    this.route.paramMap.pipe(takeUntil(this.ngUnsubscribe)).subscribe(async (params) => {
      ...
      this.query = async (offset) => {
        return await this.dataService.findArtworksByType(EntityType.MOVEMENT, [this.movementId], this.fetchOptions.fetchSize, offset);
      };
      ...
      /** load timeline items */
      await this.dataService.findArtworksByType(EntityType.MOVEMENT, [this.movement.id]).then((artworks) => {
