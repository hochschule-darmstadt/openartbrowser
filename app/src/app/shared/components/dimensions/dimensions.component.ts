...
export class DimensionsComponent implements OnInit {
  ...
  setDimensions() {
    if (this.artwork.diameter) {
      ...
      if ((this.artwork.height && this.artwork.width) || (this.artwork.height && this.artwork.length) || (this.artwork.width && this.artwork.length)) {
      ...
      if (
        ...
        this.dimensionValue =
          [this.artwork.height ? this.artwork.height : '', this.artwork.width ? this.artwork.width : '', this.artwork.length ? this.artwork.length : '']
            .filter((x) => x)
            .join(' x ') +
          ' ' +
          (this.artwork.height
            ? this.artwork.height_unit
            : this.artwork.width
            ? this.artwork.width_unit
            : this.artwork.length
            ? this.artwork.width_unit
            : 'cm');
      }
